...
Those intrinsic results do not by themselves establish supported pickup,
whole-arm reachability, hardware force/retention or magnetic assembly. Later
support studies and kinematic planning are described in the
[grasp pipeline](grasp-pipeline.md) and [runtime assembly](runtime-assembly.md).
