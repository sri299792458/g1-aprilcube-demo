...
named current-right-Dex3 pipeline retained 118/120 cube candidates. Subsequent left-hand/T/U qualification and scene-planning results are
covered in the [grasp pipeline](grasp-pipeline.md) and
[runtime assembly](runtime-assembly.md); they are separate from this early
visual checkpoint.
