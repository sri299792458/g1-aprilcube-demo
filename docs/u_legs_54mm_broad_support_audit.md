...
- Geometric survivors: **60**
- Pre-physics proposal buckets: **23**

![Selected U tabletop supports](assets/u_legs_54mm_broad_supports.png)
...
|---|---|---|---:|---:|---:|---:|
| +Y | broad_minus_y_face_down | broad_face | 89 | 87 | 52 | 52 |
| -Y | broad_plus_y_face_down | broad_face | 42 | 40 | 8 | 8 |
...
|---|---:|---:|---:|---:|---:|
| broad_minus_y_face_down | 19 | 24 | 8 | 1 | 52 |
| broad_plus_y_face_down | 1 | 4 | 2 | 1 | 8 |

The JSON artifact retains all 23 exact buckets, including surface,
