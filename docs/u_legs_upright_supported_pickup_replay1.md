# Right-Dex3 upright U exhaustive PASS replay 1
...
- PASS: **365**
- FAIL: **40**
- Retained by at least two digit chains: **365**
...
|---|---:|---:|---:|
| upright_on_leg_ends | 405 | 365 | 40 |
...
365 of 405 geometry-clear proposals passed the complete physical
contract for all 405 discovery PASS records for the upright U. These
