...
This fixture is retained from the offline support-clearance study. The later
physical stacking workflow removed the tripod; these shortlists are not that
demo's hardware grasp library. Their recorded simulated closing joints are
evidence rather than motor targets. See the
[grasp-pipeline contract](../../../docs/grasp-pipeline.md).
